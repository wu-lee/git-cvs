...
# particular, deleted files are reported as 'up to date').

# Currently, with git-cvsexport from git 1.6.3.1, this fails.
...
-two
*cvs rm two
*cvs ci -m "removed two"

# This should print 'Status: Up-to-date'
*cvs status two
...
# Check this file 'two' reappears back in GIT ok
$git->playback(<<ACTIONS);
*git-cvs pull
